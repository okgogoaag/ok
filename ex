-- Ocerium UI Library - Corrected & Beautified
-- FIX: Changed invalid property "ScrollBarImageColor" to the correct "ScrollBarImageColor3"
-- for the Page and Logs ScrollingFrames to resolve the error.
...
function Library.Main(text: string)
    ...
    function inmain.Page(text: string, iconid: string, rectOffset, rectSize, scaletype)
        ...
        local Page = make("ScrollingFrame", {
            ...
            ScrollBarImageColor3 = Library["theme"]["Accent"]; -- <<< FIX WAS HERE
            CanvasSize = UDim2.new(0, 0, 0, 0);
        ...
        function inpage.Section(text: string)
            ...
            function insection.Component(component: string, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
                ...
                if component == "Dropdown" then
                    ...
                    local SelectablesPadding = make("UIPadding", { Parent = SelectablesFrame, Padding = UDim.new(0, 5) })
